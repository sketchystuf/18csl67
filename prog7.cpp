...
divide_triangle(a,v1,v2,m-1); // triangle redivision , recursive
...
divide_triangle(v[0],v[1],v[2],m); //call for triangular face-1 division
glColor3f(0.8,0.1,0.8);
divide_triangle(v[3],v[2],v[1],m); //call for triangular face-2division
glColor3f(0.2,0.1,0.9);
divide_triangle(v[0],v[3],v[1],m); //call for triangular face-3 division
glColor3f(0.3,0.3,0.3);
divide_triangle(v[0],v[2],v[3],m); //call for triangular face-4 division
}
void display(void)
{
